...
class AppColors {
  ...
  static Color get mainBackground =>
      _isDark ? const Color(0xFF131313) : const Color(0xFFF7F7F7);
  static Color get background2 =>
      _isDark ? const Color(0xFF383838) : const Color(0xFFF0F0F0);
  static Color get cardBackground =>
      _isDark ? const Color(0xFF242424) : const Color(0xFFFFFFFF);
  ...
  static Color get text1 =>
      _isDark ? const Color(0xFFFFFFFF) : const Color(0xFF131313);
  static Color get text2 =>
      _isDark ? const Color(0xFFDDD9D9) : const Color(0xFF5A5A5A);
  static Color get text3 => _isDark
      ? const Color(0xFFFFFFFF)
      : const Color(
          0xFF000000,
        ); // originally specifically black used for content

  // Standard generic text roles
  static Color get textPrimary =>
      _isDark ? const Color(0xFFFFFFFF) : const Color(0xFF1A1A1A);
  static Color get textSecondary =>
      _isDark ? const Color(0xB3FFFFFF) : const Color(0x99000000);
  static Color get textLight =>
      _isDark ? const Color(0x80FFFFFF) : const Color(0x66000000);
  ...
  static Color get divider =>
      _isDark ? const Color(0x26FFFFFF) : const Color(0x1F000000);
  static Color get shadow =>
      _isDark ? const Color(0x40000000) : const Color(0x1A000000);

  // Platform buttons
  static Color get appleButton =>
      _isDark ? const Color(0xFFFFFFFF) : const Color(0xFF000000);
  static Color get appleButtonText =>
