...
import 'package:backpackr/features/profile/views/profile_screen.dart';
              ...
              if (showProfileAvatar)
                Padding(
                  padding: EdgeInsets.only(
                    left: (actions != null && actions!.isNotEmpty) ? 12 : 0,
                  ),
                  child: GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundColor: Colors.white.withOpacity(
                        0.2,
                      ), // Explicit contrast color against Orange gradient
